      ...
      <div className="px-10 py-12">
        <div className="flex justify-between items-end mb-8 pb-8 border-b border-[#E8E2D9]">
          ...
          <div className="flex gap-3">
            ...
            <Link href="/admin/feedback" className="px-6 py-3 border border-[#E8E2D9] text-[#888] text-[11px] tracking-[0.2em] uppercase hover:border-[#C9A84C] hover:text-[#C9A84C] transition-colors rounded-sm">💬 Feedback</Link>
